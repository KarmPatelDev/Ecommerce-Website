...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(`${process.env.REACT_APP_API}/api/v1/auth/register`, {name, emailId, password, confirmPassword, phoneNumber, address, answer});
    ...
    return (
        <Layout title={'EcomSite - Register'}>
