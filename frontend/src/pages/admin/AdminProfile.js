...
const AdminProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if(newPassword === confirmNewPassword){
                ...
                const res = await axios.put(`${process.env.REACT_APP_API}/api/v1/auth/update-admin-profile`, {name, oldPassword, newPassword, phoneNumber, address});
    ...
    return (
        <Layout title={'EcomSite - Admin Profile'}>
